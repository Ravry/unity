        ...
        Pass {
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                for (int i = 0; i < stepCount; i++)
                {
                    ...
                    float distToSphere = sdSphere(currentPos, float3(0, 1, 0), 2);
                    ...
                    if (distToSphere < epsilon)
                    {
                        ...
                        float3 normal = GetSphereNormal(currentPos, float3(0, 1, 0), 2);
                        float ambient = 0.1;
                        ...
                        half4 volumetricColor = half4(float3(shade, shade, shade), 1);
